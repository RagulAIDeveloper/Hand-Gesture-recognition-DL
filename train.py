...
model.add(Dropout(0.25)) # unnessary value remove
...
training_set = train_datagen.flow_from_directory("C:/Users/msrag/OneDrive/Desktop/Deep Learning/New folder/train",
                                                 target_size =(256,256),
...
val_set = val_datagen.flow_from_directory("C:/Users/msrag/OneDrive/Desktop/Deep Learning/New folder/val",
                                                 target_size =(256,256),
                                                 color_mode ="grayscale",
                                                 batch_size =8,
                                                 classes = ["NONE","ONE","TWO","THREE","FOUR","FIVE"],
...
# validation not imporve training stop
